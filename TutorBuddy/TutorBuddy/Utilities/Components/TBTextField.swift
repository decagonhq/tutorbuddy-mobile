...
class TBTextField: BaseView {
    ...
    convenience init(title: String, placeholder: String = "", isPassword: Bool = false, isBio: Bool = false, isUploadProfilePicture: Bool = false, height: CGFloat? = 80, validationType: ValidationType? = nil, keyboardType: UIKeyboardType = .alphabet, maxLength: Int? = nil) {
        ...
        with(textField) {
            ...
            $0.attributedPlaceholder = NSAttributedString(string: placeholder, attributes: [.font: UIFont.interRegular(size: 14), .foregroundColor: UIColor.aPlaceholderText])
    ...
    convenience init(title: String, valueText: String? = nil, placeholder: String = .CHOOSE, height: CGFloat? = 80, items: [String], validationType: ValidationType? = nil, maxLength: Int? = nil, itemSelectionHandler: IntStringParamHandler? = nil) {
        self.init(frame: .zero)
        backgroundColor = .clear
        titleLabel.text = title
        self.validationType = validationType
...
extension TBTextField: UITextFieldDelegate {
...
extension Array where Element == TBTextField {
    var areValid: Bool {
