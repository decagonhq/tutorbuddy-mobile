...
//  Autocheck Partner
//
//  Created by Isaac Iniongun on 05/04/2022.
//
...
final class ConfirmationDialogViewController: UIViewController {
    ...
    fileprivate lazy var noButton: TBButton = {
        TBButton(title: noText, backgroundColor: .clear, textColor: .primaryColor, borderWidth: 1, borderColor: .primaryColor, height: 50, tapAction: handleNoButtonTapped)
    }()
    
    fileprivate lazy var yesButton: TBButton = {
        TBButton(title: yesText, height: 50, tapAction: handleYesButtonTapped)
    }()
    ...
    fileprivate lazy var textLabel: UILabel = {
        UILabel(text: confirmationText, font: .interBold(size: 16), numberOfLines: 0, color: .primaryTextColor, alignment: .center)
    }()
