...
final class AttachmentManager: NSObject {
    ...
    struct Constants {
        ...
        static let alertForPhotoLibraryMessage = "Autochek Partner does not have access to your photos. To enable access, tap settings and turn on Photo Library Access."
        static let alertForCameraAccessMessage = "Autochek Partner does not have access to your camera. To enable access, tap settings and turn on Camera."
        static let alertForVideoLibraryMessage = "Autochek Partner does not have access to your video. To enable access, tap settings and turn on Video Library Access."
    ...
    func documentPicker() {
        ...
        let docTypes = [String(kUTTypePDF), String(kUTTypeMP3), String(kUTTypePNG), String(kUTTypeJPEG), String(kUTTypeAudio), String(kUTTypeImage), String(kUTTypeMovie), String(kUTTypeText),String(kUTTypeContent),String(kUTTypeItem),String(kUTTypeData)]
